...
echo ""
echo "Show icons for external hard drives on the desktop? (y/n)"
read -r response
if [[ $response =~ ^([yY][eE][sS]|[yY])$ ]]; then
...
echo ""
echo "Show icons for hard drives on the desktop? (y/n)"
read -r response
if [[ $response =~ ^([yY][eE][sS]|[yY])$ ]]; then
...
echo ""
echo "Show icons for servers on the desktop? (y/n)"
read -r response
if [[ $response =~ ^([yY][eE][sS]|[yY])$ ]]; then
...
echo ""
echo "Show icons for removable media on the desktop? (y/n)"
read -r response
if [[ $response =~ ^([yY][eE][sS]|[yY])$ ]]; then
...
###############################################################################
# Custom Finder Stuff Added by mkelley33
###############################################################################
